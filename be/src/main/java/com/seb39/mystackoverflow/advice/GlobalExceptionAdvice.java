package com.seb39.mystackoverflow.advice;

import com.seb39.mystackoverflow.exception.BusinessLogicException;
import com.seb39.mystackoverflow.response.ErrorResponse;
...
public class GlobalExceptionAdvice {
    ...
    public ErrorResponse handleMethodArgumentTypeMismatchException(
        ...
        if(e.getName().equals("post-type")) {
            return ErrorResponse.of(HttpStatus.BAD_REQUEST,
                    "post-type은 QUESTION, ANSWER만 허용합니다.");
        }
        final ErrorResponse response = ErrorResponse.of(HttpStatus.BAD_REQUEST,
                e.getMessage());
